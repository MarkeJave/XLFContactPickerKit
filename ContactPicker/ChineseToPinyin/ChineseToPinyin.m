...
@interface NSString_ChineseToPinyinPrivate : NSObject @end
@implementation NSString_ChineseToPinyinPrivate @end

NSString *FindLetterPrivate(int nCode) {
...
char pinyinFirstLetterPrivate(unsigned short hanzi) {
...
@implementation ChineseToPinyinPrivate
...
+ (NSString *)pinyinFromChiniseString:(NSString *)string {
    ...
    for (int i = 0; i < iLen; i++) {
		...
		NSString *strRes = FindLetterPrivate(nCode);
	...
	if( !string || 0 == [string length] )
		...
		if(([string characterAtIndex:0] > 64 && [string characterAtIndex:0] < 91) || 
		   ([string characterAtIndex:0] > 96 && [string characterAtIndex:0] < 123) ) {
			...
			cLetter = pinyinFirstLetterPrivate((unsigned short)[string characterAtIndex:0]);
...
- (NSString *)pinyin;{
    ...
    return [ChineseToPinyinPrivate pinyinFromChiniseString:self];
}
